#include "sort.h"
/**
*swap - This swap 2 nodes in a doubly-linked list.
*@a: The address of first node.
*@b: The address of second node.
*Return: void.
*/
...
/**
*tail_traverse- The function that sorts from the tail back
*@head: head of list.
...
/**
*cocktail_sort_list - This sorts linked list using cocktail shaker sort.
